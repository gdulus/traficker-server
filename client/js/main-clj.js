...
client.const$.maps = cljs.core.ObjMap.fromObject(["\ufdd0'country", "\ufdd0'overlay_id"], {"\ufdd0'country":"Germany", "\ufdd0'overlay_id":"animation_overlay"});
...
client.core.initializeCanvas = function initializeCanvas(parent) {
  var canvas_name__6133 = client.const$.maps.call(null, "\ufdd0'overlay_id");
  var attr__6134 = {"class":canvas_name__6133, "id":canvas_name__6133};
  var viewPortSize__6135 = goog.dom.getViewPortSize();
  var canvas__6136 = goog.dom.createDom("canvas", attr__6134, null);
  goog.dom.insertSiblingBefore(canvas__6136, parent);
  goog.style.setSize(canvas__6136, viewPortSize__6135);
  return canvas__6136
};
client.core.initMap = function initMap() {
  var mapContainer__6142 = goog.dom.getElement("map_canvas");
  var mapConfig__6143 = {"mapTypeId":google.maps.MapTypeId.ROADMAP};
  var geocoderConfig__6144 = {"address":client.const$.maps.call(null, "\ufdd0'country")};
  var geocoder__6145 = new google.maps.Geocoder;
  var map__6146 = new google.maps.Map(mapContainer__6142, mapConfig__6143);
  geocoder__6145.geocode(geocoderConfig__6144, function(results, status) {
    if(cljs.core._EQ_.call(null, status, google.maps.GeocoderStatus.OK)) {
      map__6146.fitBounds(client.core.getBoundsFromResults.call(null, results));
      return client.core.initializeCanvas.call(null, mapContainer__6142)
    }else {
      return null
    }
  });
...
client.core.main = function main() {
  var eb__6148 = new vertx.EventBus("http://localhost:8081/eventbus");
  eb__6148.onopen = function() {
